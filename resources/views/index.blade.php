...
<!-- owl stylesheets --> 
<link rel="stylesheet" href="{{ asset('asets/css/owl.carousel.min.css') }}">
			...
			<div class="row">
			    ...
			    <div class="col-sm-8 col-lg-4">
                  ...
                  <div class="right_main">
                     <div class="togle_main"><img src="{{ asset('assets/images/shopping-bag.png') }}"></div>
                  </div>
                 </div>
			    </div>
    ...
    <div class="carousel-item active">
      <div class="row">
				    <div class="col-sm-1">
				    	...
				    	<div class="line"><img src="{{ asset('assets/images/linr-icon.png') }}"></div>
				    	<p class="number_tetx">02/3</p>
				    	<div class="left_img"><img src="{{ asset('assets/images/img-2.png') }}"></div>
				    </div>
				    <div class="col-sm-5">
				    ...
				    <div class="col-sm-6">
				    	<div><img src="{{ asset('assets/images/img-1.png') }}"></div>
				    </div>
			    </div>
    </div>
		...
		<div class="container">
			...
			<div class="about_bg">
				<div class="row">
					...
					<div class="col-md-4">
						<div class="table_img"><img src="{{ asset('assets/images/about-img.png') }}"></div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="our_section_2">
			...
			<div class="col-sm-5">
				<div class="images_bt">
					...
					<div class="image_right">
						<div class="image_9"><img src="{{ asset('assets/images/img-9.png') }}"></div>
						<div class="new_text">NEW DESIGN</div>
					</div>
				</div>
			</div>
			<div class="col-sm-4">
				<div class="image"><img src="{{ asset('assets/images/img-4.png') }}"></div>
			</div>
			<div class="col-sm-3">
				<div class="image"><img src="{{ asset('assets/images/img-5.png') }}"></div>
			</div>
		</div>
		<div class="images_section_2">
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="image_6"><img src="{{ asset('assets/images/img-8.png') }}"></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
           <div id="my_carousel" class="carousel slide" data-ride="carousel">
			...
			<div class="testimonila_inner">
				<div class="testing_img"><img src="{{ asset('assets/images/img-10.png') }}"></div>
    					...
    					<div class="row">
    						...
    						<div class="col-sm-6 col-lg-3">
    							<div class="social_icon">
    								<ul>
    									<li><img src="{{ asset('assets/images/fb-icon.png') }}"></li>
    									<li><img src="{{ asset('assets/images/twitter-icon.png') }}"></li>
    									<li><img src="{{ asset('assets/images/in-icon.png') }}"></li>
    									<li><img src="{{ asset('assets/images/instagram-icon.png') }}"></li>
    								</ul>
    							</div>
    						</div>
    					</div>
			...
			<div class="row">
			    ...
			    <div class="col-lg-6 col-md-6 col-sm-6 ">
				   <h2 class="useful_text">Address</h2>
                     <ul class="location">
			    			<li><img src="{{ asset('assets/images/map-icon.png') }}">Locations</li>
			    			
			    			<li><img src="{{ asset('assets/images/call-icon.png') }}"><a href="company.html">+71 89078493</a></li>
			    			<li><img src="{{ asset('assets/images/email-icon.png') }}"><a href="furnitures.html">demo@gmail.com</a></li>
